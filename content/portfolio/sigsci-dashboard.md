...
**tl;dr:** Redesigned the Signal Sciences dashboard into a composable system where enterprises could configure views to match their organizational structure, system, and priorities. Hundreds of teams could monitor 40k apps and 2 trillion monthly requests for malicious signals across complex tech stacks and business unit configurations.

![The original Signal Sciences dashboard](/images/portfolio/sigsci-dashboard/signal-sciences-dashboard.png)
*The dashboard was composed high level site health (top), customizable timeseries graphs of requests tagged by business and security logic (left), and a stream of security event data (right).*
...
*Different states of the dashboard components, including empty states. Tiles could be rearranged.*
...
*Design system included dashboard layout and primitives*
